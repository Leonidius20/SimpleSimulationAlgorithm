...
public class ProbabilityDistributions {
    ...
    distribution
     */
    public static double randomExponential(double timeMean) {
        double a = 0;
        while (a == 0) {
            a = Math.random();
        }
     ...
     */
    public static double randomUniform(double timeMin, double timeMax) {
        double a = 0;
        while (a == 0) {
            a = Math.random();
        }
    ...
    distribution
     */
    public static double randomNormal(double timeMean, double
            timeDeviation) {
        double a;
        Random r = new Random();
